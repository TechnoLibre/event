...
registry
    ...
    .add("website_event_require_login_public", {
        url: "/event",
        test: true,
        steps: () => [
            {
            ...
            },
            {
                ...
                trigger:
                    "#modal_attendees_registration_login_required .modal-body",
            },
            {
            ...
            },
            {
                ...
                trigger:
                    "#modal_attendees_registration_login_required .js_goto_event",
                run: "click",
            },
        ],
    });
...
registry
    .category("web_tour.tours")
    .add("website_event_require_login_auth", {
        url: "/event",
        test: true,
        steps: () => [
            {
            ...
            {
                content:
                    "Attendee registration form appears (normal flow, no login modal)",
